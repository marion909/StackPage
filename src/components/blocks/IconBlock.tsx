...
export const ICONS: Record<string, React.ReactNode> = {
  ...
  check: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.5 12.75l6 6 9-13.5" />,
  "check-circle": <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />,
  ...
  "map-pin": <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />,
  ...
  "arrow-right": <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />,
  download: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />,
  ...
  home: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />,
};

export const ICON_NAMES = Object.keys(ICONS);

export default function IconBlock({ block }: Props) {
  const { iconName, size, color, align, label, labelColor, href } = block.props;

  const alignMap: Record<string, string> = { left: "flex-start", center: "center", right: "flex-end" };

  const content = (
    <div style={{ display: "flex", flexDirection: "column", alignItems: alignMap[align], gap: 8 }}>
      <svg
      ...
      {label && (
        <span style={{ color: labelColor, fontSize: "0.875rem", fontWeight: 500 }}>{label}</span>
      )}
    </div>
  );
